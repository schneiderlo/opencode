      ...
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          heavy: {
            ...
            description:
              "Heavy Reasoning Agent. Uses a Map-Reduce pattern to decompose complex queries into parallel sub-tasks. Best for comprehensive research, multi-part questions, or tasks requiring deep analysis.",
            prompt: PROMPT_HEAVY,
          },
          council: {
            name: "council",
            ...
            description:
              "Council Agent. Orchestrates multiple model perspectives and debates to evaluate decisions, trade-offs, and recommendations.",
        ...
        for (const [key, value] of Object.entries(cfg.agent ?? {})) {
          ...
          item.modelPool = value.modelPool ?? item.modelPool
        ...
        const defaultInfo = Effect.fnUntraced(function* () {
          ...
          const visible = Object.values(agents).find(
            (a) => a.mode !== "subagent" && a.hidden !== true && a.name !== "heavy" && a.name !== "council",
          )
